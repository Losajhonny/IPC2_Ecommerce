<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operario.aspx.cs" Inherits="ProyectoIpc2_201325583.operario" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Asociacion C.C. Operario</title>
	...
	<div id="header">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="#">Enviar archivos</a></li>
				<li><a href="#">
                    <asp:Button ID="Button2" runat="server" BackColor="Black" BorderColor="Black" ForeColor="White" Text="Perfil" OnClick="Button2_Click" />
                    </a></li>
				<li><a href="#">
                    <asp:Button ID="Button1" runat="server" BackColor="Black" BorderColor="Black" ForeColor="White" Text="Salir" OnClick="Button1_Click" />
                    </a></li>
			</ul>
		</div>
		<div id="search">
...
<div id="page"><div class="inner_copy"></div>
	<div id="page-bgtop">
		<div id="content">
			...
			<div class="post">
				<p class="meta">&nbsp;</p>
				<h2 class="title"><a href="#">Lorem</a></h2>
				<div class="entry">
					<p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
