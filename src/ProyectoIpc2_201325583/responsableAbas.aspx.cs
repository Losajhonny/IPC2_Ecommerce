...
{
    public partial class responsableAbas : System.Web.UI.Page
    {
        ...
        {
            NRegistro.insertar("responsable de abastecimiento visito formulario de cambio en su perfil --" + DateTime.Now.ToString() + "--", idEmpleado, -1);
        ...
        {
            Session.Abandon();
            NRegistro.insertar("responsable de abastecimiento cerro sesion --" + DateTime.Now.ToString() + "--", idEmpleado, -1);
            Response.Redirect("inicio.aspx");
        }
    }
}